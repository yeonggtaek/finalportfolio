...
export const CodeChallenge = () => {
  return (
    <div>
      <div className="overview-title text-[64px] text-[#007972] font-bold justify-start flex mt-10 mb-20">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-10 text-[24px] font-semibold">
          <div>
            ...
            <ul>The user needs to confirm two different actions (archiving & deleting) but creating separate modals would be inefficient.</ul>
          </div>
          <div>
        ...
        <div>
            <span className="text-[32px] font-bold">🚨 Challenge:</span> 
            <ul>The app should remember medications even after closing and reopening.</ul>
          </div>
          <div>
            <span className="text-[32px] font-bold">✅ Solution:</span>
            <ul className="list-disc">
        ...
        <div>
            <span className="text-[32px] font-bold">🚨 Challenge:</span> 
            <ul>A bottom sheet (showArchiveBottomModal) for selecting archive/delete.</ul>
            <ul>A confirmation modal (showArchiveModal) for user confirmation.</ul>
          </div>
          <div>
            <span className="text-[32px] font-bold">✅ Solution:</span>
            <ul className="list-disc">
